...
<body class="min-h-screen overflow-x-hidden text-slate-800">

    {{-- =========================================================
         HEADER
    ========================================================== --}}
    <header
        class="fixed left-0 top-0 z-50 w-full border-b border-white/20 bg-white/95 shadow-sm backdrop-blur-md"
    >
    ...
    ========================================================== --}}
    <main
        class="relative flex min-h-screen items-center justify-center overflow-hidden px-5 pb-16 pt-28 sm:px-6 sm:pt-32 lg:px-8"
    >
        ...
        <div class="absolute inset-0 z-0">
            ...
            {{-- SLIDE 1 --}}
            <div
                class="visitor-slide absolute inset-0 bg-cover bg-center opacity-100 transition-opacity duration-1000"
                style="background-image: url('{{ asset('images/landing/pag-4.png') }}');"
            ></div>

            {{-- SLIDE 2 --}}
            <div
                class="visitor-slide absolute inset-0 bg-cover bg-center opacity-0 transition-opacity duration-1000"
                style="background-image: url('{{ asset('images/landing/pag-2.webp') }}');"
            ></div>

            {{-- SLIDE 3 --}}
            <div
                class="visitor-slide absolute inset-0 bg-cover bg-center opacity-0 transition-opacity duration-1000"
                style="background-image: url('{{ asset('images/landing/pag-3.webp') }}');"
            ></div>
        ...
        <div
            class="absolute inset-0 z-10 bg-[#005DAA]/75"
        ></div>

        <div
            class="absolute inset-0 z-10 bg-gradient-to-br from-[#005DAA]/80 via-[#005DAA]/65 to-[#102A43]/80"
        ></div>
        ...
        <div
            class="absolute -right-24 -top-24 z-10 h-72 w-72 rounded-full bg-[#E31E24]/20 blur-3xl"
        ></div>

        <div
            class="absolute -bottom-24 -left-24 z-10 h-72 w-72 rounded-full bg-[#00A651]/20 blur-3xl"
        ></div>
        ...
        <div class="relative z-20 w-full max-w-2xl">
            ...
            <div class="mb-8 text-center text-white">
                ...
                <div class="mb-5 flex items-center justify-center gap-2">
                    ...
                    <span class="h-1 w-10 rounded-full bg-white"></span>
                ...
                <p
                    class="text-xs font-semibold uppercase tracking-[0.2em] text-white/80 sm:text-sm sm:tracking-[0.25em]"
                >
                    Daftar Pengunjung
                </p>

                <h2
                    class="mt-3 text-3xl font-bold leading-tight sm:text-4xl"
                >
                    Selamat Datang di
                </br>
                    <span class="text-[#E31E24]">
                        Perpustakaan Perta Arun Gas
                    </span>
                </h2>

                <p
                    class="mx-auto mt-4 max-w-xl text-sm leading-6 text-white/80 sm:text-base sm:leading-7"
                >
            ...
            <div
                class="rounded-2xl border border-white/20 bg-white p-6 shadow-2xl sm:p-8 lg:p-10"
            >
            ...
            {{-- INFO --}}
            <p
                class="mt-6 text-center text-xs leading-5 text-white/70"
            >
    ...
    ========================================================== --}}
    <footer
        class="relative z-30 bg-[#102A43] px-5 py-6 text-white sm:px-6 sm:py-8 lg:px-8"
    >
    ...
    {{-- =========================================================
         VISITOR BACKGROUND SLIDER
    ========================================================== --}}
    <script>
        document.addEventListener('DOMContentLoaded', function () {

            const slides = document.querySelectorAll('.visitor-slide');
