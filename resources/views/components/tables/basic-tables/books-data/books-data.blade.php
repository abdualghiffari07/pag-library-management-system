...
<div
    ...
    x-data="{
        ...
        getStatusClass(status) {
            const classes = {
                'Tersedia': 'bg-green-50 text-green-700 dark:bg-green-500/15 dark:text-green-400',
                'Dipinjam': 'bg-yellow-50 text-yellow-700 dark:bg-yellow-500/15 dark:text-yellow-400',
                'Hilang': 'bg-red-50 text-red-700 dark:bg-red-500/15 dark:text-red-400',
                'Rusak': 'bg-red-50 text-red-700 dark:bg-red-500/15 dark:text-red-400',
            };
...
>
    <div class="w-full min-w-0 overflow-hidden rounded-xl border border-gray-200 bg-white pt-3 dark:border-white/[0.05] dark:bg-white/[0.03]">
            ...
            <table class="min-w-[1200px] w-full table-fixed">
                    ...
                    <tr>
                        ...
                        <th class="w-[105px] px-3 py-2.5 text-left text-xs font-medium text-gray-500 dark:text-gray-400">
                            <div class="flex items-center gap-2">
                                ...
                                >
                                    <svg x-show="selectAll" width="11" height="11" viewBox="0 0 14 14" fill="none">
                ...
                <tbody>
                                ...
                                <div class="flex items-center gap-2">
                                    <button
                                        ...
                                        :class="selectedRows.includes(row.id)
                                            ...
                                            : 'border-gray-300 bg-white dark:border-gray-700 dark:bg-transparent'"
                                    >
                                        <svg x-show="selectedRows.includes(row.id)" width="11" height="11" viewBox="0 0 14 14" fill="none">
                                            <path d="M11.6668 3.5L5.25016 9.91667L2.3335 7" stroke="white" stroke-width="1.94437" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </button>
                    ...
                    <template x-if="tableRowData.length === 0">
                        <tr>
                            <td colspan="10" class="px-3 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
                                Belum ada data buku.
                            </td>
                        </tr>
                    </template>
            ...
            <div class="flex items-center justify-between">
                ...
                >
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M2.58301 9.99868L8.86018 4.46984M2.58301 9.99868L8.86018 15.5301M2.58301 9.99868H17.4175" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                ...
                >
                    ...
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M17.4175 9.9986L11.1403 4.46984M17.4175 9.9986L11.1403 15.5301M17.4175 9.9986H2.58301" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
            </div>
        </div>
