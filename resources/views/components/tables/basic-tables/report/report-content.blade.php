...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 xl:grid-cols-4">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div class="flex items-start justify-between gap-3">
            ...
            <span class="rounded-full bg-blue-50 px-2.5 py-1 text-xs font-medium text-blue-600 dark:bg-blue-500/15 dark:text-blue-400">
                Koleksi aktif
            </span>
        ...
        <div class="mt-5">
            ...
            <div class="mt-4 grid grid-cols-2 divide-x divide-gray-200 dark:divide-gray-800">
...
@php
    ...
    $recentVisitorCategoryClass = function ($category) {
    ...
    <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Aktivitas check-in terbaru di PAG Library.
            </p>
        ...
        <div class="flex items-center gap-3">
            ...
            <span class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs font-medium text-gray-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
            ...
            <a
                href="{{ route('visitors') }}"
                class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
            >
                Lihat Semua
                ...
                @forelse ($recentVisitors as $visitor)
                    ...
                    @php
                        $checkedInAt = $visitor->checked_in_at
                            ? \Carbon\Carbon::parse($visitor->checked_in_at)
                            : null;

                        $initial = mb_strtoupper(
                            mb_substr(
                                $visitor->visitor_name ?? 'P',
                                0,
                                1
                            )
                        );
                    ...
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <td class="py-3 pr-4 whitespace-nowrap">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="h-[50px] w-[50px] flex-shrink-0 overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800">

                                    @if (!empty($visitor->profile_photo))

                                        <img
                                            src="{{ route('visitors.profile-photo', ['visitor' => $visitor->visitor_id]) }}"
                                    ...
                                    @else
                                        ...
                                        <div class="flex h-full w-full items-center justify-center text-sm font-semibold text-gray-600 dark:text-gray-300">
                                            {{ $initial }}
                                        </div>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <a
                                        href="{{ route('visitors.details', ['visitor' => $visitor->visitor_id]) }}"
                                        class="block max-w-[220px] truncate text-sm font-medium text-gray-800 transition hover:text-blue-600 dark:text-white/90 dark:hover:text-blue-400"
                                    >
                                        {{ $visitor->visitor_name }}
                                    </a>

                                    <span class="mt-1 block text-xs text-gray-500 dark:text-gray-400">
                                        {{ $visitor->phone_number ?: 'No. HP tidak tersedia' }}
                                    </span>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            <span class="{{ $recentVisitorCategoryClass($visitor->visitor_category) }}">
                                {{ $recentVisitorCategories[$visitor->visitor_category] ?? 'Lainnya' }}
                            </span>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            @if ($checkedInAt)
                                ...
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    {{ $checkedInAt->locale('id')->translatedFormat('d M Y') }}
                                </p>
                        ...
                        <td class="py-3 pl-4 whitespace-nowrap">
                            ...
                            <span class="inline-flex items-center gap-1.5 rounded-full bg-green-50 px-2.5 py-1 text-xs font-medium text-green-600 dark:bg-green-500/15 dark:text-green-400">
                        ...
                        >
                            ...
                            <div class="mx-auto flex max-w-sm flex-col items-center">
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Data akan muncul setelah pengunjung melakukan check-in.
                                </p>
