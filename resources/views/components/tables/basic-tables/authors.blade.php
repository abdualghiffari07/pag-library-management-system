            ...
            <thead>
                <tr class="border-y border-gray-100 dark:border-gray-800">
                    <th class="px-3 py-3 text-left font-normal">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">No</p>
                    </th>
                    <th class="px-3 py-3 text-left font-normal">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">ID Penulis</p>
                    </th>
                    <th class="px-3 py-3 text-left font-normal">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">Penulis</p>
                    </th>
                    <th class="px-3 py-3 text-left font-normal">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">Buku</p>
                    </th>
                    <th class="px-3 py-3 text-left font-normal">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">Dibuat</p>
                    </th>
                    <th class="px-3 py-3 text-left font-normal">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">Aksi</p>
                    </th>
                </tr>
            </thead>

            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                <template x-for="author in paginatedItems" :key="author.id">
                    <tr>
                        <td class="px-3 py-3">
                            <p class="text-gray-700 text-theme-sm dark:text-gray-400" x-text="author.no"></p>
                        </td>
                        ...
                        <td class="px-3 py-3">
                            <p class="font-medium text-gray-700 text-theme-sm dark:text-gray-300" x-text="author.name"></p>
                        </td>
                        ...
                        <td class="px-3 py-3">
                            <span class="text-gray-500 text-theme-sm dark:text-gray-400" x-text="author.created_at"></span>
                        </td>
                        ...
                        <td class="px-3 py-3">
                            <div class="flex items-center gap-2">
                                <a
                                    ...
                                    class="inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-theme-xs font-medium text-gray-600 transition hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                                >
                                    Kelola
                                </a>
