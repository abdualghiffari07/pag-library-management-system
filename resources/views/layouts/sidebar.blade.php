    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/dashboard">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="/images/logo/logo-pertamina.svg" alt="Logo" width="150" height="40" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="/images/logo/logo-pertamina-white.svg" alt="Logo" width="150"
                height="40" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="/images/logo/pertamina.svg" alt="Logo" width="32" height="32" />
        </a>
    </div>
...
<!-- Sign Out -->
<div class="mt-auto pb-5 pt-4 border-t border-gray-200 dark:border-gray-800">
